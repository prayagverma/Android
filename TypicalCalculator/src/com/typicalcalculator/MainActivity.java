...
Button b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,b12,b13,b14,b15,b16,b17,b18,b19,b20;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b19 = (Button) findViewById(R.id.button19);b19.setOnClickListener(this);
        b20 = (Button) findViewById(R.id.button20);b20.setOnClickListener(this);
      ...
      l=e1.getText().toString();
			...
			try {
				...
				if(v==b4){
					...
					else if("+".equals(l.substring(l.length() - 1)) || "/".equals(l.substring(l.length() - 1)) || "-".equals(l.substring(l.length() - 1)) || "*".equals(l.substring(l.length() - 1))){
						m = l.substring(0, e1.length()-1); 
						e1.setText("");
						e1.append(m + b4.getText().toString());
					}
						else {
					...
					if("".equals(e1.getText().toString())){
						...
						m = l.substring(0, e1.length()-1); 
						e1.setText("");
						e1.append(m + b15.getText().toString());
					}
						else {
					e1.append(b15.getText().toString());
					}
				}
				else if(v==b14){
					if("".equals(e1.getText().toString())){
						...
						m = l.substring(0, e1.length()-1); 
						e1.setText("");
						e1.append(m + b14.getText().toString());
					}
						else {
					e1.append(b14.getText().toString());
					}
				}
				else if(v==b13){
					if("".equals(e1.getText().toString())){
						...
						m = l.substring(0, e1.length()-1); 
						e1.setText("");
						e1.append(m + b13.getText().toString());
					}
						else {
					e1.append(b13.getText().toString());
					}
				}
					...
					if("".equals(e1.getText().toString())){
						...
						Toast.makeText(this, "Enter Some Operand First",Toast.LENGTH_SHORT).show();	
					}
					
					else{  
						m= e1.getText().toString();
						 DoubleEvaluator engine = new DoubleEvaluator();
	                        Double ddd = engine.evaluate(m);
	                        e1.setText(ddd.toString());
 					    }
					}
				else if(v==b18){
